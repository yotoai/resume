...
$(function() {
	...
	var top7 = $("#section8").offset().top - 30;
	var tops = [top1, top2, top3, top4, top5, top6, top7];
	$(window).resize();
	...
	$(window).scroll(function() {
		...
		if((s > top1) && (s < top2)) {
			...
			$(".nav-xs-ul li").eq(6).addClass("active").siblings().removeClass("active");
